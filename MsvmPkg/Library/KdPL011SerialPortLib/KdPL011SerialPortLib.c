  ...
  )
{
  ...
  Status =  PL011UartInitializePort (
              (UINTN)FixedPcdGet64 (PcdCom1RegisterBase),  // MS_HYP_CHANGE
...
{
  return PL011UartWrite ((UINTN)FixedPcdGet64 (PcdCom1RegisterBase), Buffer, NumberOfBytes); // MS_HYP_CHANGE
}
...
{
  return PL011UartRead ((UINTN)FixedPcdGet64 (PcdCom1RegisterBase), Buffer, NumberOfBytes); // MS_HYP_CHANGE
}
...
{
  return PL011UartPoll ((UINTN)FixedPcdGet64 (PcdCom1RegisterBase));  // MS_HYP_CHANGE
}
...
{
  return PL011UartSetControl ((UINTN)FixedPcdGet64 (PcdCom1RegisterBase), Control); // MS_HYP_CHANGE
}
...
{
  return PL011UartGetControl ((UINTN)FixedPcdGet64 (PcdCom1RegisterBase), Control); // MS_HYP_CHANGE
}