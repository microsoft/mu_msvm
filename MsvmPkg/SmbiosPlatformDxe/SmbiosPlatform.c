...
--*/
{
  ...
  if (stringLength) {
    strings[0] =
      LoadPcdSmbiosString (
        PcdGet64 (PcdSmbiosSystemManufacturerStr),
        stringLength,
  ...
  if (stringLength) {
    strings[1] =
      LoadPcdSmbiosString (
        PcdGet64 (PcdSmbiosSystemProductNameStr),
        stringLength,
        BiosInterfaceSmbiosStringMax + 1
        );
  }
  ...
  if (stringLength) {
    strings[2] =
      LoadPcdSmbiosString (
        PcdGet64 (PcdSmbiosSystemVersionStr),
        stringLength,
        BiosInterfaceSmbiosStringMax + 1
        );
  }
  ...
  strings[3] =
    LoadPcdSmbiosString (
      PcdGet64 (PcdSmbiosSystemSerialNumberStr),
  ...
  if (stringLength) {
    strings[4] =
      LoadPcdSmbiosString (
        PcdGet64 (PcdSmbiosSystemSKUNumberStr),
        stringLength,
        BiosInterfaceSmbiosStringMax + 1
        );
  }
  ...
  if (stringLength) {
    strings[5] =
      LoadPcdSmbiosString (
        PcdGet64 (PcdSmbiosSystemFamilyStr),
        stringLength,
        BiosInterfaceSmbiosStringMax + 1
        );
  }
...
--*/
{
  ...
  strings[2] =
    LoadPcdSmbiosString (
      PcdGet64 (PcdSmbiosChassisSerialNumberStr),
  ...
  strings[3] =
    LoadPcdSmbiosString (
      PcdGet64 (PcdSmbiosChassisAssetTagStr),
...
--*/
{
  ...
  strings[3] =
    LoadPcdSmbiosString (
      PcdGet64 (PcdSmbiosBaseSerialNumberStr),
...
--*/
{
  ...
  cpuf->L1CacheHandle         = 0xFFFF; // L1 Cache Handle - Unknown
  cpuf->L2CacheHandle         = 0xFFFF; // L2 Cache Handle - Unknown
  ...
  *((UINT8 *)(&cpuInfo.Formatted.Voltage))      = PcdGet8 (PcdSmbiosProcessorVoltage);
  ...
  strings[0] =
    LoadPcdSmbiosString (
      PcdGet64 (PcdSmbiosProcessorSocketDesignationStr),
  ...
  strings[1] =
    LoadPcdSmbiosString (
      PcdGet64 (PcdSmbiosProcessorManufacturerStr),
  ...
  strings[2] =
    LoadPcdSmbiosString (
      PcdGet64 (PcdSmbiosProcessorVersionStr),
  ...
  strings[3] =
    LoadPcdSmbiosString (
      PcdGet64 (PcdSmbiosProcessorSerialNumberStr),
  ...
  strings[4] =
    LoadPcdSmbiosString (
      PcdGet64 (PcdSmbiosProcessorAssetTagStr),
  ...
  strings[5] =
    LoadPcdSmbiosString (
      PcdGet64 (PcdSmbiosProcessorPartNumberStr),
...
--*/
{
  ...
  strings[1] =
    LoadPcdSmbiosString (
      PcdGet64 (PcdSmbiosBiosLockStringStr),
...
--*/
{
  ...
  if (AsciiStrCmp (LocationString, LOCATION_STRING_PRIMARY_MEMORY_DEVICE) == 0) {
    ...
    if (stringLength) {
      strings[3] =
        LoadPcdSmbiosString (
          PcdGet64 (PcdSmbiosMemoryDeviceSerialNumberStr),
          stringLength,
          BiosInterfaceSmbiosStringMax + 1
          );
    }
...
--*/
{
        ...
        ))
  {
    ...
    if (Length > 0) {
      ...
      //
      if (AddMemoryArrayMappedAddress (
            Smbios,
            BaseAddress,
            Length,
            PhysicalMemoryArrayHandle,
