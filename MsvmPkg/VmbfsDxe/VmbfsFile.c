...
--*/
{
  ...
  CopyMem (
    getFileInfoMessage->FilePath,
    filePath,
    filePathLengthInBytes
    );

  status = VmbfsSendReceivePacket (
             GetFileSystemInformation (parentFileInformation),
             getFileInfoMessage,
