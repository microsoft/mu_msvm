...
STATIC_ASSERT_1((sizeof(VMSTORAGE_CHANNEL_PROPERTIES) % 4) == 0);
...
STATIC_ASSERT_1((sizeof(VMSTORAGE_PROTOCOL_VERSION) % 4) == 0);
...
STATIC_ASSERT_1((sizeof(VMFC_WWN_PACKET) % 4) == 0);
...
STATIC_ASSERT_1((sizeof(VSTOR_CLIENT_PROPERTIES) % 4) == 0);
...
STATIC_ASSERT_1((sizeof(VSTOR_ASYNC_REGISTER_PACKET) % 4) == 0);
...
STATIC_ASSERT_1((sizeof(VSTOR_NOTIFICATION_PACKET) % 4) == 0);
...
STATIC_ASSERT_1((sizeof(VSTOR_PACKET) % 8) == 0);
...
STATIC_ASSERT_1(VMSTORAGE_SIZEOF_VSTOR_PACKET_REVISION_1 == 0x30);
...
STATIC_ASSERT_1(VMSTORAGE_SIZEOF_VSTOR_PACKET_REVISION_2 == 0x40);
